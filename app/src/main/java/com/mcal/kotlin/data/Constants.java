...
public final class Constants {
    public static final String PACKAGE_NAME = Utils.xor("てどと〨とづつな〫ねなひどはに", true); // com.mcal.kotlin
    ...
    public static final String INITIALIZE = Utils.xor("てで〨でふぶ〨ぶばつ〨〷〱〷〴〲〼〳〱〴〲〱〱〷〵〳〰️へ〶〴〴〰️〼〳〱〷〴〾", true); // ca-app-pub-1411495427741055~3216954118
    public static final String ADMOB_BANNER = Utils.xor("てで〨でふぶ〨ぶばつ〨〷〱〷〴〲〼〳〱〴〲〱〱〷〵〳〰️〩〰️〿〰️〿〵〿〷〳〰️〲", true); // ca-app-pub-1411495427741055/5959092554
    public static final String ADMOB_INTERSTITIAL = Utils.xor("てで〨でふぶ〨ぶばつ〨〷〱〷〴〲〼〳〱〴〲〱〱〷〵〳〰️〩〶〴〱〷〵〶〱〾〱〴", true); // ca-app-pub-1411495427741055/3241004842
    ...
    private static final String MCAL_LLC = Utils.xor("ねひぱぶぶ〼〪〩ぱはとふてぴぬぶぱどび〨ぢはぱのばつ〫はな〩のひ〪ぶつちだふ", true); // https://timscriptov.github.io/kt/pages
